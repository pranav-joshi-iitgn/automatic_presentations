#set page(width: 1920pt, height: 1080pt, margin: 100pt, fill: rgb("1e1e2e"))
#set text(font: "Liberation Sans", size: 60pt, fill: rgb("cdd6f4"))
...
= Why Automate?
- *Consistency:* Every video looks and sounds the same.
...
/* NOTE 3: Thank you for your time. Feel free to explore the code and modify it for your own text to speech models. */